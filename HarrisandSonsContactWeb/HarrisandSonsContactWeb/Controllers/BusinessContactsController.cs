...
using HarrisandSonsContactWeb.Data;
using HarrisandSonsContactWeb.Models;

namespace HarrisandSonsContactWeb.Controllers
{
    public class BusinessContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BusinessContactID,BusinessFname,BusinessLname,BusinessEmail,BusinessAddress1,BusinessAddress2,BusinessCity,BusinessPostCode,BusinessTel")] BusinessContact businessContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BusinessContactID,BusinessFname,BusinessLname,BusinessEmail,BusinessAddress1,BusinessAddress2,BusinessCity,BusinessPostCode,BusinessTel")] BusinessContact businessContact)
        {
